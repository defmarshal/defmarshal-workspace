...
This index is auto‑generated. Last updated: 2026-03-01 07:20 UTC (233 entries)

## 2026 Reports (233 total)

### 2026-03
- [AI Developer Tools 2026 — Cursor $29.3B/18% mkt share/$1B ARR, Copilot 4.7M subs/multi-model platform (Claude+Codex+Copilot agents), Claude Code Agent Teams (80.8% SWE-bench, 4% GitHub commits), Google Antigravity Manager view (agent-first IDE, free Gemini 3.1 Pro, Feb 26), Windsurf SWE-grep 20×, Replit Agent, Cline BYOK headless; vibe coding (25% YC25 startups 95% AI code), open-source maintainer crisis, head-to-head benchmark; pricing table, multi-agent direction](2026-03-01-ai-developer-tools-2026-cursor-29b-github-copilot-4-7m-subscribers-claude-code-agent-teams-google-antigravity-vibe-coding.md)
- [Quantum Computing 2026 — IonQ $130M FY2025 (+202%, first $100M GAAP public QC), $235M FY26 guidance, SkyWater acquisition; IBM Nighthawk (120q, 30% more complexity), Kookaburra (4,158q logical qubits 2026), Starling (200 logical q 2028); Microsoft Majorana 1 topological qubit (contested, lower error overhead thesis); Google Willow 105q 13,000× speedup (RCS caveat); Quantinuum $1B Qatar JV H3 99.9%; IonQ stock correction from hype peaks; post-quantum NIST CRYSTALS-Kyber/Dilithium standards; hardware taxonomy (5 qubit types); $40B+ govt investment; hype-reality gap table](2026-03-01-quantum-computing-2026-ionq-100m-revenue-ibm-nighthawk-kookaburra-microsoft-majorana-google-willow-post-quantum-cryptography.md)
